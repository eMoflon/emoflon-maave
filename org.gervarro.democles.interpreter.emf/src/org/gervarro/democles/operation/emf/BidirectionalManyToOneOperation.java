...
public class BidirectionalManyToOneOperation extends BidirectionalReference {
	
	public BidirectionalManyToOneOperation(EMFConstraintModule module, EReference eReference) {
