...
public class UserDefinedConstraintsImpl extends EObjectImpl implements UserDefinedConstraints {
	...
	public void _NC_SingeltonSystem(SystemTimer system1, SystemTimer system2) {
		...
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_0_1_SingeltonSystem_blackBB(system1, system2);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [SingeltonSystem] failed." + " Variables: "
	...
	public void _NC_SingeltonCurrentSem(Semester sem2, Semester sem1) {
		// SingeltonCurrentSem 
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_1_1_SingeltonCurrentSem_blackBB(sem1, sem2);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [SingeltonCurrentSem ] failed." + " Variables: "
					+ "[sem1] = " + sem1 + ", " + "[sem2] = " + sem2 + ".");
		}
		return;
	}
	...
	public void _NC_NoTwoEnrollmentsWithSameID(Enrollment en1, Enrollment en2) {
		...
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_2_1_NoTwoEnrollmentsWithSameID_blackBB(en1, en2);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [NoTwoEnrollmentsWithSameID] failed." + " Variables: "
					+ "[en1] = " + en1 + ", " + "[en2] = " + en2 + ".");
		}
		return;
	}
	...
	public void _NC_NoTwoEntriesWithSameID(GradeFormular gf) {
		// NoTwoEntriesWithSameID
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_3_1_NoTwoEntriesWithSameID_blackBFF(gf);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [NoTwoEntriesWithSameID] failed." + " Variables: "
					+ "[gf] = " + gf + ".");
		}
		// Entry e1 = (Entry) result1_black[1];
		// Entry e2 = (Entry) result1_black[2];
		return;
	}
	...
	public void _NC_onlyOneRecordForModuleOfferAndExam(Enrollment en) {
		// onlyOneRecordForModuleOfferAndExam
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_4_1_onlyOneRecordForModuleOfferAndExam_blackBFFF(en);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [onlyOneRecordForModuleOfferAndExam] failed."
					+ " Variables: " + "[en] = " + en + ".");
		}
		// CoModOffer cmo = (CoModOffer) result1_black[1];
		// Record re1 = (Record) result1_black[2];
		// Record re2 = (Record) result1_black[3];
		return;
	}
	...
	public void _XNC_onlyOneCMOPerExam(Enrollment en) {
		// onlyOneCMOPerExam
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_5_1_onlyOneCMOPerExam_blackBFFFFF(en);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [onlyOneCMOPerExam] failed." + " Variables: " + "[en] = " + en + ".");
		}
		// Record re1 = (Record) result1_black[1];
		// Record re2 = (Record) result1_black[2];
		// CoModOffer cmo1 = (CoModOffer) result1_black[3];
		// CoModOffer cmo2 = (CoModOffer) result1_black[4];
		// Exam ex = (Exam) result1_black[5];
		return;
	}
	...
	public void _NC_OnlyOneRegPerEnrollment(Record rec2, Record rec1) {
		// ActivityNode1
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_6_1_ActivityNode1_blackBBFF(rec1, rec2);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [ActivityNode1] failed." + " Variables: " + "[rec1] = "
					+ rec1 + ", " + "[rec2] = " + rec2 + ".");
		}
		// Enrollment en = (Enrollment) result1_black[2];
	...
	public void _NC_NoCompetingBookings(Room room) {
		// NoCompetingBookings
		Object[] result1_black = UserDefinedConstraintsImpl
				.pattern_UserDefinedConstraints_7_1_NoCompetingBookings_blackBFF(room);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [NoCompetingBookings] failed." + " Variables: "
					+ "[room] = " + room + ".");
		}
		// Booking boA = (Booking) result1_black[1];
		// Booking boB = (Booking) result1_black[2];
		return;
	}
	...
	public static final Object[] pattern_UserDefinedConstraints_0_1_SingeltonSystem_blackBB(SystemTimer system1,
			SystemTimer system2) {
	...
	public static final Object[] pattern_UserDefinedConstraints_1_1_SingeltonCurrentSem_blackBB(Semester sem1,
			Semester sem2) {
		if (!sem1.equals(sem2)) {
	...
	public static final Object[] pattern_UserDefinedConstraints_2_1_NoTwoEnrollmentsWithSameID_blackBB(Enrollment en1,
			Enrollment en2) {
		if (!en1.equals(en2)) {
	...
	public static final Object[] pattern_UserDefinedConstraints_4_1_onlyOneRecordForModuleOfferAndExam_blackBFFF(
			Enrollment en) {
