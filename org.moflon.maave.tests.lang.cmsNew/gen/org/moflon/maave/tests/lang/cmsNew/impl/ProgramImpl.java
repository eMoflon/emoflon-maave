 ...
 * <ul>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ProgramImpl#getThesisModules
 * <em>Thesis Modules</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ProgramImpl#getModules
 * <em>Modules</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ProgramImpl#getReqCp
 * <em>Req Cp</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ProgramImpl#getId
 * <em>Id</em>}</li>
 * </ul>
 * </p>
 *
...
public class ProgramImpl extends EObjectImpl implements Program {
	/**
	 * The cached value of the '{@link #getThesisModules() <em>Thesis Modules</em>}'
	...
	public NotificationChain basicSetThesisModules(ThesisModule newThesisModules, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CmsNewPackage.PROGRAM__THESIS_MODULES, oldThesisModules, newThesisModules);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setThesisModules(ThesisModule newThesisModules) {
		if (newThesisModules != thesisModules) {
			...
			if (thesisModules != null)
				msgs = ((InternalEObject) thesisModules).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.PROGRAM__THESIS_MODULES, null, msgs);
			if (newThesisModules != null)
				msgs = ((InternalEObject) newThesisModules).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.PROGRAM__THESIS_MODULES, null, msgs);
			msgs = basicSetThesisModules(newThesisModules, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.PROGRAM__THESIS_MODULES,
					newThesisModules, newThesisModules));
	}
