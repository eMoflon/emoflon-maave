...
public class EnrollmentImpl extends EObjectImpl implements Enrollment {
	...
	public EList<Record> getRecords() {
		if (records == null) {
			records = new EObjectContainmentWithInverseEList<Record>(Record.class, this,
					CmsNewPackage.ENROLLMENT__RECORDS, CmsNewPackage.RECORD__ENROLLMENT);
		}
		return records;
	}
		...
		if (program != null && program.eIsProxy()) {
			...
			if (program != oldProgram) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.ENROLLMENT__PROGRAM,
							oldProgram, program));
			}
		}
		return program;
	...
	public void setProgram(Program newProgram) {
		...
		program = newProgram;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.ENROLLMENT__PROGRAM, oldProgram,
					program));
	}
	...
	public NotificationChain basicSetDegree(Degree newDegree, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CmsNewPackage.ENROLLMENT__DEGREE, oldDegree, newDegree);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDegree != degree) {
			...
			if (degree != null)
				msgs = ((InternalEObject) degree).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.ENROLLMENT__DEGREE, null, msgs);
			if (newDegree != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.ENROLLMENT__DEGREE, newDegree,
					newDegree));
	}
	...
	public NotificationChain basicSetThesisRecord(ThesisRecord newThesisRecord, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CmsNewPackage.ENROLLMENT__THESIS_RECORD, oldThesisRecord, newThesisRecord);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newThesisRecord != thesisRecord) {
			...
			if (thesisRecord != null)
				msgs = ((InternalEObject) thesisRecord).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.ENROLLMENT__THESIS_RECORD, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.ENROLLMENT__THESIS_RECORD,
					newThesisRecord, newThesisRecord));
	}
	...
	public void setStudId(int newStudId) {
		...
		studId = newStudId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.ENROLLMENT__STUD_ID, oldStudId,
					studId));
	}
	...
	public void setEnrolled(boolean newEnrolled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.ENROLLMENT__ENROLLED, oldEnrolled,
					enrolled));
	}
	...
	public void regForExam_v1(SystemTimer st, Exam ex) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EN_regExam_v1] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[ex] = " + ex + ", " + "[st] = " + st + ".");
		}
		Record record = (Record) result1_black[2];
		// CoModOffer moduleOfferREG = (CoModOffer) result1_black[3];
		// Semester sem = (Semester) result1_black[5];
		int record_tries_prime_1 = (int) result1_black[6];
		int ex_regSt_prime_1 = (int) result1_black[7];
		EnrollmentImpl.pattern_Enrollment_0_1_EN_regExam_v1_greenBBBB(ex, record, record_tries_prime_1,
				ex_regSt_prime_1);
	...
	public void unregFromExam_v1(Exam ex, SystemTimer system) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EN_unregExam_v1] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[ex] = " + ex + ", " + "[system] = " + system + ".");
		}
		Record record = (Record) result1_black[2];
		// CoModOffer moduleOffer = (CoModOffer) result1_black[3];
		...
		EnrollmentImpl.pattern_Enrollment_1_1_EN_unregExam_v1_greenBBBB(ex, record, ex_regSt_prime_1,
	...
	public void regForExam_v0(Exam ex) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EN_regExam_v0] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[ex] = " + ex + ".");
		}
		Record record = (Record) result1_black[2];
		// CoModOffer moduleOfferREG = (CoModOffer) result1_black[3];
		...
		EnrollmentImpl.pattern_Enrollment_2_1_EN_regExam_v0_greenBBBB(ex, record, record_tries_prime_1,
				ex_regSt_prime_1);
	...
	public void regForModule_v0(CoModOffer mo) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EN_regCMO_v0] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[mo] = " + mo + ".");
		}
		// Module module = (Module) result1_black[1];
		...
		EnrollmentImpl.pattern_Enrollment_3_1_EN_regCMO_v0_greenBFBBBB(this, mo, record_grade_prime_1,
	...
	public void unregFromExam_v0(Exam ex) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EN_unregExam_v0] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[ex] = " + ex + ".");
		}
		Record record = (Record) result1_black[2];
		// CoModOffer moduleOffer = (CoModOffer) result1_black[3];
		...
		EnrollmentImpl.pattern_Enrollment_4_1_EN_unregExam_v0_greenBBBB(ex, record, ex_regSt_prime_1,
				record_tries_prime_1);
	...
	public void regForThesisModuleOffer_v0(ThesisModuleOffer thModOffer) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EN_regTMO_v0] failed." + " Variables: " + "[this] = "
					+ this + ", " + "[thModOffer] = " + thModOffer + ".");
		}
		// Program prog = (Program) result1_black[2];
		// ThesisModule thesisModule = (ThesisModule) result1_black[3];
		...
		EnrollmentImpl.pattern_Enrollment_5_1_EN_regTMO_v0_greenBBFBBB(this, thModOffer, this_state_prime_1,
				thesisRecord_grade_prime_1, thesisRecord_tries_prime_1);
		// ThesisRecord thesisRecord = (ThesisRecord) result1_green[2];
	...
	public void regForThesis_v0() {
		...
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [EN_regThesis_v0] failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		EnrollmentImpl.pattern_Enrollment_6_1_EN_regThesis_v0_greenBBFB(thesisModOffer, thesisRecord,
				thesisRecord_tries_prime_1);
		// Thesis thesis = (Thesis) result1_green[2];
	...
	public void obtainDegree_v0() {
		...
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [EN_obtDeg_v0] failed." + " Variables: " + "[this] = " + this + ".");
		}
		// Program prog = (Program) result1_black[1];
		...
		// Degree degree = (Degree) result1_green[1];
	...
	public static final Object[] pattern_Enrollment_0_1_EN_regExam_v1_blackBBFFBFFF(Enrollment _this, Exam ex,
			SystemTimer st) {
											...
											if (record_grade > 4) {
												...
												if (is_STUDY_STATE || is_THESIS_STATE) {
													...
													if (record_tries_prime <= 3) {
														return new Object[] { _this, ex, record, moduleOfferREG, st,
																sem, record_tries_prime, ex_regSt_prime };
													}
												}
											}
	...
	public static final Object[] pattern_Enrollment_0_1_EN_regExam_v1_greenBBBB(Exam ex, Record record,
			int record_tries_prime, int ex_regSt_prime) {
		record.setExam(ex);
	...
	public static final Object[] pattern_Enrollment_1_1_EN_unregExam_v1_blackBBFFFBFF(Enrollment _this, Exam ex,
			SystemTimer system) {
									...
									if (moduleOffer != null) {
										if (ex.equals(moduleOffer.getExams())) {
											...
											if (is_STUDY_STATE || is_THESIS_STATE) {
												...
												record_tries_prime = record_tries - 1;
												return new Object[] { _this, ex, record, moduleOffer, currSem, system,
														ex_regSt_prime, record_tries_prime };
											}
	...
	public static final Object[] pattern_Enrollment_1_1_EN_unregExam_v1_greenBBBB(Exam ex, Record record,
			int ex_regSt_prime, int record_tries_prime) {
		ex.setRegSt(Integer.valueOf(ex_regSt_prime));
		record.setTries(Integer.valueOf(record_tries_prime));
						...
						if (ex.equals(moduleOfferREG.getExams())) {
							...
							if (record_grade > 4) {
								...
								if (is_STUDY_STATE || is_THESIS_STATE) {
									...
									record_tries_prime = record_tries + 1;
									if (record_tries_prime <= 3) {
										return new Object[] { _this, ex, record, moduleOfferREG, record_tries_prime,
												ex_regSt_prime };
									}
								}
							}
	...
	public static final Object[] pattern_Enrollment_2_1_EN_regExam_v0_greenBBBB(Exam ex, Record record,
			int record_tries_prime, int ex_regSt_prime) {
		record.setExam(ex);
		record.setTries(Integer.valueOf(record_tries_prime));
		ex.setRegSt(Integer.valueOf(ex_regSt_prime));
						...
						for (Module module : program.getModules()) {
							if (mo.equals(module.getCurrent())) {
								...
								if (is_STUDY_STATE || is_THESIS_STATE) {
									...
									return new Object[] { _this, module, program, mo, record_grade_prime,
	...
	public static final Object[] pattern_Enrollment_3_1_EN_regCMO_v0_greenBFBBBB(Enrollment _this, CoModOffer mo,
			int record_grade_prime, int record_tries_prime, int this_regCp_prime) {
					...
					if (moduleOffer != null) {
						if (ex.equals(moduleOffer.getExams())) {
							...
							if (is_STUDY_STATE || is_THESIS_STATE) {
								...
								record_tries_prime = record_tries - 1;
								return new Object[] { _this, ex, record, moduleOffer, ex_regSt_prime,
										record_tries_prime };
							}
	...
	public static final Object[] pattern_Enrollment_4_1_EN_unregExam_v0_greenBBBB(Exam ex, Record record,
			int ex_regSt_prime, int record_tries_prime) {
		ex.setRegSt(Integer.valueOf(ex_regSt_prime));
		record.setTries(Integer.valueOf(record_tries_prime));
		return new Object[] { ex, record, ex_regSt_prime, record_tries_prime };
	...
	public static final Object[] pattern_Enrollment_5_1_EN_regTMO_v0_blackBBFFFFF(Enrollment _this,
			ThesisModuleOffer thModOffer) {
					...
					if (this_enrolled == true) {
						...
						if (thesisModule != null) {
							if (thModOffer.equals(thesisModule.getActThesModOffer())) {
								...
								return new Object[] { _this, thModOffer, prog, thesisModule, this_state_prime,
										thesisRecord_grade_prime, thesisRecord_tries_prime };
							}
						}
					}
				}
	...
	public static final Object[] pattern_Enrollment_5_1_EN_regTMO_v0_greenBBFBBB(Enrollment _this,
			ThesisModuleOffer thModOffer, EN_STATE this_state_prime, int thesisRecord_grade_prime,
			int thesisRecord_tries_prime) {
		...
		return new Object[] { _this, thModOffer, thesisRecord, this_state_prime, thesisRecord_grade_prime,
				thesisRecord_tries_prime };
	}
						...
						if (thesisModOffer != null) {
							...
							if (thesisRecord_grade > 4) {
								...
								if (thesisRecord_tries_prime <= 2) {
									return new Object[] { _this, thesisModOffer, thesisRecord,
											thesisRecord_tries_prime };
								}
							}
	...
	public static final Object[] pattern_Enrollment_6_1_EN_regThesis_v0_greenBBFB(ThesisModuleOffer thesisModOffer,
			ThesisRecord thesisRecord, int thesisRecord_tries_prime) {
	...
	public static final Object[] pattern_Enrollment_7_1_EN_obtDeg_v0_greenBFB(Enrollment _this,
			EN_STATE this_state_prime) {
