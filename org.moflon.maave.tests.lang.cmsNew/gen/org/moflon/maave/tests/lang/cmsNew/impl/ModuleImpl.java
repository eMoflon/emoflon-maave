 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ModuleImpl#getLecMan <em>Lec Man</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ModuleImpl#getAllOffers <em>All Offers</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ModuleImpl#getCurrent <em>Current</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ModuleImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ModuleImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
{
   /**
    * The cached value of the '{@link #getAllOffers() <em>All Offers</em>}' containment reference list.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see #getAllOffers()
    * @generated
   ...
   {
      if (newLecMan != eInternalContainer() || (eContainerFeatureID() != CmsNewPackage.MODULE__LEC_MAN && newLecMan != null))
      {
         ...
         if (newLecMan != null)
            msgs = ((InternalEObject) newLecMan).eInverseAdd(this, CmsNewPackage.COURSE_MANAGEMENT__MODULES, CourseManagement.class, msgs);
   ...
   public EList<CoModOffer> getAllOffers()
   {
      if (allOffers == null)
      {
         allOffers = new EObjectContainmentEList<CoModOffer>(CoModOffer.class, this, CmsNewPackage.MODULE__ALL_OFFERS);
      }
      return allOffers;
   }
      ...
      if (current != null && current.eIsProxy())
      {
         ...
         if (current != oldCurrent)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.MODULE__CURRENT, oldCurrent, current));
         }
      }
      return current;
   }
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
      case CmsNewPackage.MODULE__LEC_MAN:
         return eInternalContainer().eInverseRemove(this, CmsNewPackage.COURSE_MANAGEMENT__MODULES, CourseManagement.class, msgs);
      }
