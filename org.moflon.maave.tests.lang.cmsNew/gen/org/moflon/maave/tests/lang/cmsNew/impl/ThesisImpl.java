 ...
 * <ul>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisImpl#getRecord
 * <em>Record</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisImpl#getGrade
 * <em>Grade</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisImpl#getState
 * <em>State</em>}</li>
 * </ul>
 * </p>
 *
...
public class ThesisImpl extends EObjectImpl implements Thesis {
		...
		if (record != null && record.eIsProxy()) {
			...
			if (record != oldRecord) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.THESIS__RECORD, oldRecord,
							record));
			}
		}
		return record;
	...
	public NotificationChain basicSetRecord(ThesisRecord newRecord, NotificationChain msgs) {
		...
		record = newRecord;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.THESIS__RECORD,
					oldRecord, newRecord);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRecord(ThesisRecord newRecord) {
		if (newRecord != record) {
			...
			if (record != null)
				msgs = ((InternalEObject) record).eInverseRemove(this, CmsNewPackage.THESIS_RECORD__THESIS,
						ThesisRecord.class, msgs);
			if (newRecord != null)
				msgs = ((InternalEObject) newRecord).eInverseAdd(this, CmsNewPackage.THESIS_RECORD__THESIS,
						ThesisRecord.class, msgs);
	...
	public static final Object[] pattern_Thesis_0_1_TH_enterGrade_v0_greenBB(ThesisRecord thRec,
			int thRec_grade_prime) {
