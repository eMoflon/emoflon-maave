 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisRecordImpl#getThesis <em>Thesis</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisRecordImpl#getThesisOffer <em>Thesis Offer</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisRecordImpl#getGrade <em>Grade</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisRecordImpl#getTries <em>Tries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThesisRecordImpl extends EObjectImpl implements ThesisRecord
{
   ...
   /**
    * The cached value of the '{@link #getThesisOffer() <em>Thesis Offer</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see #getThesisOffer()
    * @generated
      ...
      if (thesis != null && thesis.eIsProxy())
      {
         ...
         if (thesis != oldThesis)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.THESIS_RECORD__THESIS, oldThesis, thesis));
         }
      }
      return thesis;
   }
   ...
   public NotificationChain basicSetThesis(Thesis newThesis, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.THESIS_RECORD__THESIS, oldThesis, newThesis);
         if (msgs == null)
            msgs = notification;
         else
   ...
   public void setThesis(Thesis newThesis)
   {
      if (newThesis != thesis)
      {
         ...
         if (thesis != null)
            msgs = ((InternalEObject) thesis).eInverseRemove(this, CmsNewPackage.THESIS__RECORD, Thesis.class, msgs);
         if (newThesis != null)
            msgs = ((InternalEObject) newThesis).eInverseAdd(this, CmsNewPackage.THESIS__RECORD, Thesis.class, msgs);
         msgs = basicSetThesis(newThesis, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.THESIS_RECORD__THESIS, newThesis, newThesis));
   }
   ...
   public ThesisModuleOffer getThesisOffer()
   {
      if (thesisOffer != null && thesisOffer.eIsProxy())
      {
         ...
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.THESIS_RECORD__THESIS_OFFER, oldThesisOffer, thesisOffer));
         }
      }
      return thesisOffer;
   }
   ...
   public void setThesisOffer(ThesisModuleOffer newThesisOffer)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.THESIS_RECORD__THESIS_OFFER, oldThesisOffer, thesisOffer));
   }
