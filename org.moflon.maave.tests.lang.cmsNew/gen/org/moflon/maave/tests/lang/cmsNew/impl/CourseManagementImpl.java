...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Course Management</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CourseManagementImpl#getPrograms <em>Programs</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CourseManagementImpl#getSemesters <em>Semesters</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CourseManagementImpl#getModuleOffers <em>Module Offers</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CourseManagementImpl#getModules <em>Modules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CourseManagementImpl extends EObjectImpl implements CourseManagement
{
   ...
   public EList<Program> getPrograms()
   {
      if (programs == null)
      {
         programs = new EObjectContainmentEList<Program>(Program.class, this, CmsNewPackage.COURSE_MANAGEMENT__PROGRAMS);
      }
      return programs;
   }
   ...
   public EList<Semester> getSemesters()
   {
      if (semesters == null)
      {
         semesters = new EObjectContainmentWithInverseEList<Semester>(Semester.class, this, CmsNewPackage.COURSE_MANAGEMENT__SEMESTERS,
               CmsNewPackage.SEMESTER__LECTURE_MAN);
      }
      return semesters;
   }
   ...
   public EList<CoModOffer> getModuleOffers()
   {
      ...
      {
         moduleOffers = new EObjectContainmentWithInverseEList<CoModOffer>(CoModOffer.class, this, CmsNewPackage.COURSE_MANAGEMENT__MODULE_OFFERS,
               CmsNewPackage.CO_MOD_OFFER__LEC_MAN);
      }
      return moduleOffers;
   }
   ...
   public EList<Module> getModules()
   {
      if (modules == null)
      {
         modules = new EObjectContainmentWithInverseEList<Module>(Module.class, this, CmsNewPackage.COURSE_MANAGEMENT__MODULES, CmsNewPackage.MODULE__LEC_MAN);
      }
      return modules;
   }
