 ...
 * <ul>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getLectureMan
 * <em>Lecture Man</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getExams
 * <em>Exams</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getPrevious
 * <em>Previous</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getNext
 * <em>Next</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getOfferedLectures
 * <em>Offered Lectures</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getRegPeriodStart
 * <em>Reg Period Start</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getRegPeriodStop
 * <em>Reg Period Stop</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getStartDate
 * <em>Start Date</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getEndDate
 * <em>End Date</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#isCurrent
 * <em>Current</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SemesterImpl#getState
 * <em>State</em>}</li>
 * </ul>
 * </p>
 *
...
public class SemesterImpl extends EObjectImpl implements Semester {
	/**
	 * The cached value of the '{@link #getExams() <em>Exams</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getOfferedLectures() <em>Offered
	 * Lectures</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getRegPeriodStart() <em>Reg Period
	...
	/**
	 * The cached value of the '{@link #getRegPeriodStart() <em>Reg Period
	 * Start</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRegPeriodStart()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getRegPeriodStop() <em>Reg Period
	 * Stop</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getRegPeriodStop() <em>Reg Period
	 * Stop</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRegPeriodStop()
	 * @generated
	...
	public void setLectureMan(CourseManagement newLectureMan) {
		if (newLectureMan != eInternalContainer()
				|| (eContainerFeatureID() != CmsNewPackage.SEMESTER__LECTURE_MAN && newLectureMan != null)) {
			...
			if (newLectureMan != null)
				msgs = ((InternalEObject) newLectureMan).eInverseAdd(this, CmsNewPackage.COURSE_MANAGEMENT__SEMESTERS,
						CourseManagement.class, msgs);
			msgs = basicSetLectureMan(newLectureMan, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__LECTURE_MAN, newLectureMan,
					newLectureMan));
	}
	...
	public EList<Exam> getExams() {
		if (exams == null) {
			exams = new EObjectContainmentWithInverseEList<Exam>(Exam.class, this, CmsNewPackage.SEMESTER__EXAMS,
					CmsNewPackage.EXAM__SEMESTER);
		}
		return exams;
	}
		...
		if (previous != null && previous.eIsProxy()) {
			...
			if (previous != oldPrevious) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.SEMESTER__PREVIOUS,
	...
	public NotificationChain basicSetPrevious(Semester newPrevious, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CmsNewPackage.SEMESTER__PREVIOUS, oldPrevious, newPrevious);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPrevious(Semester newPrevious) {
		if (newPrevious != previous) {
			NotificationChain msgs = null;
			if (previous != null)
				msgs = ((InternalEObject) previous).eInverseRemove(this, CmsNewPackage.SEMESTER__NEXT, Semester.class,
						msgs);
			if (newPrevious != null)
				msgs = ((InternalEObject) newPrevious).eInverseAdd(this, CmsNewPackage.SEMESTER__NEXT, Semester.class,
						msgs);
			msgs = basicSetPrevious(newPrevious, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__PREVIOUS, newPrevious,
					newPrevious));
	}
	...
	public Semester getNext() {
		if (next != null && next.eIsProxy()) {
			...
			if (next != oldNext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.SEMESTER__NEXT, oldNext,
							next));
			}
		}
		return next;
	...
	public NotificationChain basicSetNext(Semester newNext, NotificationChain msgs) {
		...
		next = newNext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__NEXT,
					oldNext, newNext);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setNext(Semester newNext) {
		if (newNext != next) {
			NotificationChain msgs = null;
			if (next != null)
				msgs = ((InternalEObject) next).eInverseRemove(this, CmsNewPackage.SEMESTER__PREVIOUS, Semester.class,
						msgs);
			if (newNext != null)
				msgs = ((InternalEObject) newNext).eInverseAdd(this, CmsNewPackage.SEMESTER__PREVIOUS, Semester.class,
						msgs);
	...
	public EList<Lecture> getOfferedLectures() {
		if (offeredLectures == null) {
			offeredLectures = new EObjectContainmentWithInverseEList<Lecture>(Lecture.class, this,
					CmsNewPackage.SEMESTER__OFFERED_LECTURES, CmsNewPackage.LECTURE__SEMESTER);
		}
	...
	public void setRegPeriodStart(long newRegPeriodStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__REG_PERIOD_START,
					oldRegPeriodStart, regPeriodStart));
	}
	...
	public void setRegPeriodStop(long newRegPeriodStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__REG_PERIOD_STOP,
					oldRegPeriodStop, regPeriodStop));
	}
	...
	public void setStartDate(long newStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__START_DATE, oldStartDate,
					startDate));
	}
	...
	public void setEndDate(long newEndDate) {
		...
		endDate = newEndDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__END_DATE, oldEndDate,
					endDate));
	}
	...
	public void setCurrent(boolean newCurrent) {
		...
		current = newCurrent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SEMESTER__CURRENT, oldCurrent,
					current));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CmsNewPackage.SEMESTER__LECTURE_MAN:
			return eInternalContainer().eInverseRemove(this, CmsNewPackage.COURSE_MANAGEMENT__SEMESTERS,
					CourseManagement.class, msgs);
		}
