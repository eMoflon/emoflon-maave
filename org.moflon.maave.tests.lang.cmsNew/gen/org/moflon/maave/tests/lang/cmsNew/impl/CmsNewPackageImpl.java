...
public class CmsNewPackageImpl extends EPackageImpl implements CmsNewPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link CmsNewPackage#eINSTANCE} when that
	...
	public static CmsNewPackage init() {
		...
		CmsNewPackageImpl theCmsNewPackage = (CmsNewPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof CmsNewPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void createPackageContents() {
		...
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___NC_SINGELTON_SYSTEM__SYSTEMTIMER_SYSTEMTIMER);
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___NC_SINGELTON_CURRENT_SEM__SEMESTER_SEMESTER);
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___NC_NO_TWO_ENROLLMENTS_WITH_SAME_ID__ENROLLMENT_ENROLLMENT);
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___NC_NO_TWO_ENTRIES_WITH_SAME_ID__GRADEFORMULAR);
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___NC_ONLY_ONE_RECORD_FOR_MODULE_OFFER_AND_EXAM__ENROLLMENT);
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___XNC_ONLY_ONE_CMO_PER_EXAM__ENROLLMENT);
		createEOperation(userDefinedConstraintsEClass,
				USER_DEFINED_CONSTRAINTS___NC_ONLY_ONE_REG_PER_ENROLLMENT__RECORD_RECORD);
	...
	public void initializePackageContents() {
		...
		initEReference(getThesis_Record(), this.getThesisRecord(), this.getThesisRecord_Thesis(), "record", null, 0, 1,
				Thesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThesis_Grade(), ecorePackage.getEInt(), "grade", null, 0, 1, Thesis.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getThesis_State(), this.getTH_STATE(), "state", null, 0, 1, Thesis.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getEnrollment_Cp(), ecorePackage.getEInt(), "cp", null, 1, 1, Enrollment.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getEnrollment_State(), this.getEN_STATE(), "state", null, 1, 1, Enrollment.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getEnrollment_RegCp(), ecorePackage.getEInt(), "regCp", null, 1, 1, Enrollment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getEnrollment_StudId(), ecorePackage.getEInt(), "studId", null, 0, 1, Enrollment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getEnrollment_Enrolled(), ecorePackage.getEBoolean(), "enrolled", null, 0, 1, Enrollment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		EOperation op = initEOperation(getEnrollment__RegForExam_v1__SystemTimer_Exam(), null, "regForExam_v1", 0, 1,
		...
		op = initEOperation(getEnrollment__UnregFromExam_v1__Exam_SystemTimer(), null, "unregFromExam_v1", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getExam(), "ex", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getEnrollment__RegForModule_v0__CoModOffer(), null, "regForModule_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getCoModOffer(), "mo", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getEnrollment__UnregFromExam_v0__Exam(), null, "unregFromExam_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getExam(), "ex", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getEnrollment__RegForThesisModuleOffer_v0__ThesisModuleOffer(), null,
				"regForThesisModuleOffer_v0", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getLecture_Semester(), this.getSemester(), this.getSemester_OfferedLectures(), "semester", null,
				0, 1, Lecture.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLecture_Date(), this.getDate(), null, "date", null, 0, -1, Lecture.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLecture_RegSt(), ecorePackage.getEInt(), "regSt", null, 0, 1, Lecture.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(moduleEClass, Module.class, "Module", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModule_LecMan(), this.getCourseManagement(), this.getCourseManagement_Modules(), "lecMan",
				null, 0, 1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModule_AllOffers(), this.getCoModOffer(), null, "allOffers", null, 0, -1, Module.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModule_Current(), this.getCoModOffer(), null, "current", null, 0, 1, Module.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDate_Location(), this.getBooking(), null, "location", null, 0, 1, Date.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getDate_Begin(), ecorePackage.getELong(), "begin", null, 1, 1, Date.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getDate_Duration(), ecorePackage.getELong(), "duration", null, 1, 1, Date.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(thesisModuleEClass, ThesisModule.class, "ThesisModule", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getThesisModule_ActThesModOffer(), this.getThesisModuleOffer(), null, "actThesModOffer", null, 0,
				1, ThesisModule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThesisModule_Id(), ecorePackage.getELong(), "id", null, 0, 1, ThesisModule.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);

		initEClass(coModOfferEClass, CoModOffer.class, "CoModOffer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCoModOffer_LecMan(), this.getCourseManagement(), this.getCourseManagement_ModuleOffers(),
				"lecMan", null, 0, 1, CoModOffer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCoModOffer_Exams(), this.getExam(), null, "exams", null, 0, 1, CoModOffer.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCoModOffer_Lectures(), this.getLecture(), null, "lectures", null, 0, 1, CoModOffer.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCoModOffer_Cp(), ecorePackage.getEInt(), "cp", null, 1, 1, CoModOffer.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCoModOffer_State(), this.getCMO_STATE(), "state", null, 0, 1, CoModOffer.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		op = initEOperation(getCoModOffer__UpdateExam_v1__SystemTimer_Exam(), null, "updateExam_v1", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getSystemTimer(), "system", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getExam(), "ex", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getCoModOffer__SetLecture_v0__Lecture(), null, "setLecture_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		op = initEOperation(getCoModOffer__UpdateLecture_v0__Lecture(), null, "updateLecture_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		initEClass(courseManagementEClass, CourseManagement.class, "CourseManagement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCourseManagement_Programs(), this.getProgram(), null, "programs", null, 0, -1,
				CourseManagement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourseManagement_Semesters(), this.getSemester(), this.getSemester_LectureMan(), "semesters",
				null, 0, -1, CourseManagement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourseManagement_ModuleOffers(), this.getCoModOffer(), this.getCoModOffer_LecMan(),
				"moduleOffers", null, 0, -1, CourseManagement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourseManagement_Modules(), this.getModule(), this.getModule_LecMan(), "modules", null, 0, -1,
				CourseManagement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getUserDefinedConstraints___NC_SingeltonSystem__SystemTimer_SystemTimer(), null,
				"_NC_SingeltonSystem", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getUserDefinedConstraints___NC_SingeltonCurrentSem__Semester_Semester(), null,
				"_NC_SingeltonCurrentSem", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getUserDefinedConstraints___NC_NoTwoEnrollmentsWithSameID__Enrollment_Enrollment(), null,
				"_NC_NoTwoEnrollmentsWithSameID", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getUserDefinedConstraints___NC_NoTwoEntriesWithSameID__GradeFormular(), null,
				"_NC_NoTwoEntriesWithSameID", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getGradeFormular(), "gf", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getUserDefinedConstraints___NC_onlyOneRecordForModuleOfferAndExam__Enrollment(), null,
				"_NC_onlyOneRecordForModuleOfferAndExam", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getEnrollment(), "en", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getUserDefinedConstraints___XNC_onlyOneCMOPerExam__Enrollment(), null,
				"_XNC_onlyOneCMOPerExam", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getEnrollment(), "en", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getUserDefinedConstraints___NC_OnlyOneRegPerEnrollment__Record_Record(), null,
				"_NC_OnlyOneRegPerEnrollment", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getUserDefinedConstraints___NC_NoCompetingBookings__Room(), null, "_NC_NoCompetingBookings",
		...
		initEReference(getRecord_Exam(), this.getExam(), this.getExam_Registrations(), "exam", null, 0, 1, Record.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRecord_ModuleOffer(), this.getCoModOffer(), null, "moduleOffer", null, 0, 1, Record.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProgram_Modules(), this.getModule(), null, "modules", null, 0, -1, Program.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProgram_ReqCp(), ecorePackage.getEInt(), "reqCp", null, 1, 1, Program.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getProgram_Id(), ecorePackage.getEInt(), "id", null, 1, 1, Program.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(cmsEClass, org.moflon.maave.tests.lang.cmsNew.CMS.class, "CMS", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCMS_RoomManagement(), this.getRoomManagement(), null, "roomManagement", null, 1, 1,
				org.moflon.maave.tests.lang.cmsNew.CMS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCMS_CourseManagement(), this.getCourseManagement(), null, "courseManagement", null, 1, 1,
				org.moflon.maave.tests.lang.cmsNew.CMS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(examEClass, Exam.class, "Exam", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExam_Semester(), this.getSemester(), this.getSemester_Exams(), "semester", null, 0, 1,
		...
		initEReference(getExam_Registrations(), this.getRecord(), this.getRecord_Exam(), "registrations", null, 0, -1,
				Exam.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExam_Date(), this.getDate(), null, "date", null, 0, 1, Exam.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getExam_GradeList(), this.getGradeFormular(), null, "gradeList", null, 0, 1, Exam.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExam_RegSt(), ecorePackage.getEInt(), "regSt", null, 1, 1, Exam.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEOperation(getExam__TransferResultPassed_v0(), null, "transferResultPassed_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEOperation(getExam__TransferResultFailed_v0(), null, "transferResultFailed_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = initEOperation(getExam__BookRoom_v0__Room(), null, "bookRoom_v0", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getRoom(), "ro", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getExam__UploadResults_v0__GradeFormular(), null, "uploadResults_v0", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getGradeFormular(), "gF", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getExam__CloseExam_v0(), null, "closeExam_v0", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getExam__TransferResultPassed_v1__SystemTimer(), null, "transferResultPassed_v1", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSystemTimer(), "system", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getExam__TransferResultFailed_v1__SystemTimer(), null, "transferResultFailed_v1", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSystemTimer(), "system", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(thesisRecordEClass, ThesisRecord.class, "ThesisRecord", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getThesisRecord_Thesis(), this.getThesis(), this.getThesis_Record(), "thesis", null, 0, 1,
				ThesisRecord.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThesisRecord_ThesisOffer(), this.getThesisModuleOffer(), null, "thesisOffer", null, 0, 1,
				ThesisRecord.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThesisRecord_Grade(), ecorePackage.getEInt(), "grade", null, 1, 1, ThesisRecord.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEClass(semesterEClass, Semester.class, "Semester", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSemester_LectureMan(), this.getCourseManagement(), this.getCourseManagement_Semesters(),
				"lectureMan", null, 0, 1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSemester_Exams(), this.getExam(), this.getExam_Semester(), "exams", null, 0, -1,
		...
		initEReference(getSemester_Next(), this.getSemester(), this.getSemester_Previous(), "next", null, 0, 1,
				Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSemester_OfferedLectures(), this.getLecture(), this.getLecture_Semester(), "offeredLectures",
				null, 0, -1, Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSemester_RegPeriodStart(), ecorePackage.getELong(), "regPeriodStart", null, 0, 1,
				Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSemester_RegPeriodStop(), ecorePackage.getELong(), "regPeriodStop", null, 1, 1,
				Semester.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getSemester_EndDate(), ecorePackage.getELong(), "endDate", null, 1, 1, Semester.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getSemester_Current(), ecorePackage.getEBoolean(), "current", null, 1, 1, Semester.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEAttribute(getSemester_State(), this.getSEM_STATE(), "state", null, 0, 1, Semester.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(systemTimerEClass, SystemTimer.class, "SystemTimer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSystemTimer_CurrentTime(), ecorePackage.getELong(), "currentTime", null, 0, 1,
				SystemTimer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);

		initEClass(thesisModuleOfferEClass, ThesisModuleOffer.class, "ThesisModuleOffer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getThesisModuleOffer_Thesiss(), this.getThesis(), null, "thesiss", null, 0, -1,
				ThesisModuleOffer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThesisModuleOffer_Cp(), ecorePackage.getEInt(), "cp", null, 0, 1, ThesisModuleOffer.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
