...
public class LectureImpl extends EObjectImpl implements Lecture
{
   ...
   {
      if (newSemester != eInternalContainer() || (eContainerFeatureID() != CmsNewPackage.LECTURE__SEMESTER && newSemester != null))
      {
         ...
         if (newSemester != null)
            msgs = ((InternalEObject) newSemester).eInverseAdd(this, CmsNewPackage.SEMESTER__OFFERED_LECTURES, Semester.class, msgs);
         msgs = basicSetSemester(newSemester, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.LECTURE__SEMESTER, newSemester, newSemester));
   }
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
      case CmsNewPackage.LECTURE__SEMESTER:
         return eInternalContainer().eInverseRemove(this, CmsNewPackage.SEMESTER__OFFERED_LECTURES, Semester.class, msgs);
      }
