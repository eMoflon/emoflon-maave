 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.RecordImpl#getEnrollment <em>Enrollment</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.RecordImpl#getExam <em>Exam</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.RecordImpl#getModuleOffer <em>Module Offer</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.RecordImpl#getGrade <em>Grade</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.RecordImpl#getTries <em>Tries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RecordImpl extends EObjectImpl implements Record
{
   ...
   {
      if (newEnrollment != eInternalContainer() || (eContainerFeatureID() != CmsNewPackage.RECORD__ENROLLMENT && newEnrollment != null))
      {
         ...
         if (newEnrollment != null)
            msgs = ((InternalEObject) newEnrollment).eInverseAdd(this, CmsNewPackage.ENROLLMENT__RECORDS, Enrollment.class, msgs);
         msgs = basicSetEnrollment(newEnrollment, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.RECORD__ENROLLMENT, newEnrollment, newEnrollment));
   }
      ...
      if (exam != null && exam.eIsProxy())
      {
         ...
         if (exam != oldExam)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.RECORD__EXAM, oldExam, exam));
         }
      }
      return exam;
   }
   ...
   public NotificationChain basicSetExam(Exam newExam, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.RECORD__EXAM, oldExam, newExam);
         if (msgs == null)
            msgs = notification;
         else
   ...
   public void setExam(Exam newExam)
   {
      if (newExam != exam)
      {
         NotificationChain msgs = null;
         if (exam != null)
            msgs = ((InternalEObject) exam).eInverseRemove(this, CmsNewPackage.EXAM__REGISTRATIONS, Exam.class, msgs);
         if (newExam != null)
            msgs = ((InternalEObject) newExam).eInverseAdd(this, CmsNewPackage.EXAM__REGISTRATIONS, Exam.class, msgs);
   ...
   public CoModOffer getModuleOffer()
   {
      if (moduleOffer != null && moduleOffer.eIsProxy())
      {
         ...
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.RECORD__MODULE_OFFER, oldModuleOffer, moduleOffer));
         }
      }
      return moduleOffer;
   }
   ...
   public void setModuleOffer(CoModOffer newModuleOffer)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.RECORD__MODULE_OFFER, oldModuleOffer, moduleOffer));
   }
