...
public class CoModOfferImpl extends EObjectImpl implements CoModOffer
{
   ...
   {
      if (newLecMan != eInternalContainer() || (eContainerFeatureID() != CmsNewPackage.CO_MOD_OFFER__LEC_MAN && newLecMan != null))
      {
         ...
         if (newLecMan != null)
            msgs = ((InternalEObject) newLecMan).eInverseAdd(this, CmsNewPackage.COURSE_MANAGEMENT__MODULE_OFFERS, CourseManagement.class, msgs);
         msgs = basicSetLecMan(newLecMan, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.CO_MOD_OFFER__LEC_MAN, newLecMan, newLecMan));
   }
      ...
      if (exams != null && exams.eIsProxy())
      {
         ...
         if (exams != oldExams)
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.CO_MOD_OFFER__EXAMS, oldExams, exams));
         }
      }
      return exams;
   }
   ...
   public Lecture getLectures()
   {
      if (lectures != null && lectures.eIsProxy())
      {
         ...
         {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsNewPackage.CO_MOD_OFFER__LECTURES, oldLectures, lectures));
         }
      }
      return lectures;
   }
   ...
   public void setLectures(Lecture newLectures)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.CO_MOD_OFFER__LECTURES, oldLectures, lectures));
   }
   ...
   public void updateExam_v1(SystemTimer system, Exam ex)
   {
      ...
      if (result1_black == null)
      {
         throw new RuntimeException(
               "Pattern matching failed." + " Variables: " + "[system] = " + system + ", " + "[this] = " + this + ", " + "[ex] = " + ex + ".");
      }
      Exam exOld = (Exam) result1_black[2];
      //nothing Semester currSem = (Semester) result1_black[4];
      //nothing Semester semOld = (Semester) result1_black[5];
   ...
   public void setLecture_v0(Lecture lect)
   {
      ...
      if (result1_black == null)
      {
         throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[lect] = " + lect + ".");
      }
      //nothing Semester semCurr = (Semester) result1_black[0];
      //nothing Semester semNext = (Semester) result1_black[1];
   ...
   public void updateExam_v0(Exam ex)
   {
      ...
      //nothing Semester semCurr = (Semester) result1_black[3];
      //nothing Semester semOld = (Semester) result1_black[4];
   ...
   public void updateLecture_v0(Lecture lec)
   {
      ...
      if (result1_black == null)
      {
         throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[lec] = " + lec + ".");
      }
      //nothing Semester semCurr = (Semester) result1_black[0];
      //nothing Semester semNext = (Semester) result1_black[1];
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
   {
      ...
      {
      case CmsNewPackage.CO_MOD_OFFER__LEC_MAN:
         return eInternalContainer().eInverseRemove(this, CmsNewPackage.COURSE_MANAGEMENT__MODULE_OFFERS, CourseManagement.class, msgs);
      }
   ...
   public static final Object[] pattern_CoModOffer_0_1_CMO_updateEx_v1_blackBBFBFFF(SystemTimer system, CoModOffer _this, Exam ex)
   {
                        ...
                        if (currSem_current == true)
                        {
                           ...
                           if (system_currentTime < currSem_regPeriodStart)
                           {
                              ...
                              if (system_currentTime > currSem_startDate)
                              {
                                 ...
                                 {
                                    return new Object[] { system, _this, exOld, ex, currSem, semOld, this_state_prime };
                                 }
                              }
                           }
                        }
   ...
   public static final Object[] pattern_CoModOffer_0_1_CMO_updateEx_v1_greenBBB(CoModOffer _this, Exam ex, CMO_STATE this_state_prime)
   {
      _this.setExams(ex);
   ...
   public static final Object[] pattern_CoModOffer_1_1_CMO_setLecture_v0_greenBBB(CoModOffer _this, Lecture lect, CMO_STATE this_state_prime)
   {
   ...
   public static final Object[] pattern_CoModOffer_2_1_CMO_setExam_v0_greenBBB(CoModOffer _this, Exam ex, CMO_STATE this_state_prime)
   {
      _this.setExams(ex);
      _this.setState(this_state_prime);
      return new Object[] { _this, ex, this_state_prime };
   ...
   public static final Object[] pattern_CoModOffer_3_1_CMO_resetCMO_v0_greenBB(CoModOffer _this, CMO_STATE this_state_prime)
   {
      _this.setState(this_state_prime);
      return new Object[] { _this, this_state_prime };
   }
   ...
   public static final Object[] pattern_CoModOffer_4_1_CMO_updateEx_v0_greenBBB(CoModOffer _this, Exam ex, CMO_STATE this_state_prime)
   {
      _this.setExams(ex);
      _this.setState(this_state_prime);
      return new Object[] { _this, ex, this_state_prime };
   ...
   public static final Object[] pattern_CoModOffer_5_1_CMO_updateLect_v0_greenBBB(CoModOffer _this, Lecture lec, CMO_STATE this_state_prime)
   {
   ...
   public static final Object[] pattern_CoModOffer_6_1_MO_closeModOffer_v0_greenBB(CoModOffer _this, CMO_STATE this_state_prime)
   {
      _this.setState(this_state_prime);
      return new Object[] { _this, this_state_prime };
   }
