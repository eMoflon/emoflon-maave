...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Co Mod
 * Offer</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CoModOfferImpl#getLecMan
 * <em>Lec Man</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CoModOfferImpl#getExams
 * <em>Exams</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CoModOfferImpl#getLectures
 * <em>Lectures</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CoModOfferImpl#getCp
 * <em>Cp</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.CoModOfferImpl#getState
 * <em>State</em>}</li>
 * </ul>
 * </p>
 *
...
public class CoModOfferImpl extends EObjectImpl implements CoModOffer {
	...
	public void updateExam_v1(SystemTimer system, Exam ex) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[system] = " + system + ", "
					+ "[this] = " + this + ", " + "[ex] = " + ex + ".");
		}
	...
	public void setLecture_v0(Lecture lect) {
		...
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[lect] = " + lect + ".");
		}
	...
	public void updateLecture_v0(Lecture lec) {
		...
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[lec] = " + lec + ".");
		}
		// nothing Semester semCurr = (Semester) result1_black[0];
		// nothing Semester semNext = (Semester) result1_black[1];
