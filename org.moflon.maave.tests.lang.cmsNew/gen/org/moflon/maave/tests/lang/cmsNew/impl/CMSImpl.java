...
public class CMSImpl extends EObjectImpl implements CMS
{
   ...
   public NotificationChain basicSetRoomManagement(RoomManagement newRoomManagement, NotificationChain msgs)
   {
      ...
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.CMS__ROOM_MANAGEMENT, oldRoomManagement,
               newRoomManagement);
         if (msgs == null)
            msgs = notification;
         else
   ...
   public void setRoomManagement(RoomManagement newRoomManagement)
   {
      if (newRoomManagement != roomManagement)
      {
         ...
         if (roomManagement != null)
            msgs = ((InternalEObject) roomManagement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CmsNewPackage.CMS__ROOM_MANAGEMENT, null, msgs);
         if (newRoomManagement != null)
            msgs = ((InternalEObject) newRoomManagement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CmsNewPackage.CMS__ROOM_MANAGEMENT, null, msgs);
         msgs = basicSetRoomManagement(newRoomManagement, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.CMS__ROOM_MANAGEMENT, newRoomManagement, newRoomManagement));
   }
   ...
   public NotificationChain basicSetCourseManagement(CourseManagement newCourseManagement, NotificationChain msgs)
   {
      ...
      if (eNotificationRequired())
      {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.CMS__COURSE_MANAGEMENT, oldCourseManagement,
               newCourseManagement);
         if (msgs == null)
            msgs = notification;
         else
   ...
   public void setCourseManagement(CourseManagement newCourseManagement)
   {
      if (newCourseManagement != courseManagement)
      {
         ...
         if (courseManagement != null)
            msgs = ((InternalEObject) courseManagement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CmsNewPackage.CMS__COURSE_MANAGEMENT, null, msgs);
         if (newCourseManagement != null)
            msgs = ((InternalEObject) newCourseManagement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CmsNewPackage.CMS__COURSE_MANAGEMENT, null, msgs);
         msgs = basicSetCourseManagement(newCourseManagement, msgs);
         if (msgs != null)
            msgs.dispatch();
      } else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.CMS__COURSE_MANAGEMENT, newCourseManagement, newCourseManagement));
   }
