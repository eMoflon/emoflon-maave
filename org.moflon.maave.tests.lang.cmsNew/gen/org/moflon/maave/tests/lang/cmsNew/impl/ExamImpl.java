...
public class ExamImpl extends EObjectImpl implements Exam {
	...
	public void setSemester(Semester newSemester) {
		if (newSemester != eInternalContainer()
				|| (eContainerFeatureID() != CmsNewPackage.EXAM__SEMESTER && newSemester != null)) {
			...
			if (newSemester != null)
				msgs = ((InternalEObject) newSemester).eInverseAdd(this, CmsNewPackage.SEMESTER__EXAMS, Semester.class,
						msgs);
			msgs = basicSetSemester(newSemester, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.EXAM__SEMESTER, newSemester,
					newSemester));
	}
	...
	public EList<Record> getRegistrations() {
		if (registrations == null) {
			registrations = new EObjectWithInverseResolvingEList<Record>(Record.class, this,
					CmsNewPackage.EXAM__REGISTRATIONS, CmsNewPackage.RECORD__EXAM);
		}
	...
	public NotificationChain basicSetDate(Date newDate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CmsNewPackage.EXAM__DATE,
					oldDate, newDate);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDate(Date newDate) {
		if (newDate != date) {
			NotificationChain msgs = null;
			if (date != null)
				msgs = ((InternalEObject) date).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CmsNewPackage.EXAM__DATE,
						null, msgs);
			if (newDate != null)
				msgs = ((InternalEObject) newDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CmsNewPackage.EXAM__DATE,
						null, msgs);
	...
	public NotificationChain basicSetGradeList(GradeFormular newGradeList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CmsNewPackage.EXAM__GRADE_LIST, oldGradeList, newGradeList);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newGradeList != gradeList) {
			...
			if (gradeList != null)
				msgs = ((InternalEObject) gradeList).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.EXAM__GRADE_LIST, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.EXAM__GRADE_LIST, newGradeList,
					newGradeList));
	}
	...
	public void zetDate_v0(Date da) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_setDate_v0] failed." + " Variables: " + "[da] = "
					+ da + ", " + "[this] = " + this + ".");
		}
	...
	public void updateDate_v0(Date da) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_updateDate_v0] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[da] = " + da + ".");
		}
	...
	public void bookRoom_v1(Room ro, SystemTimer system) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_bookRoom_v1] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[ro] = " + ro + ", " + "[system] = " + system + ".");
		}
		Date da = (Date) result1_black[2];
		// Semester currSem = (Semester) result1_black[3];
		...
		ExamImpl.pattern_Exam_2_1_EX_bookRoom_v1_greenBBFBBBB(this, ro, da, bo_end_prime_1, bo_begin_prime_1,
				this_state_prime_1);
	...
	public void transferResultPassed_v0() {
		...
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [EX_transResPas_v0] failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		// CoModOffer moduleOffer = (CoModOffer) result1_black[4];
		...
		ExamImpl.pattern_Exam_3_1_EX_transResPas_v0_greenBBBB(rec, enrollment, rec_grade_prime_1,
				enrollment_cp_prime_1);
	...
	public void transferResultFailed_v0() {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_transResFail_v0] failed." + " Variables: "
					+ "[this] = " + this + ".");
		}
		...
		ExamImpl.pattern_Exam_4_1_EX_transResFail_v0_greenBBBB(rec, enrollment, rec_grade_prime_1,
				enrollment_enrolled_prime_1);
	...
	public void bookRoom_v0(Room ro) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_bookRoom_v0] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[ro] = " + ro + ".");
		}
		...
		ExamImpl.pattern_Exam_5_1_EX_bookRoom_v0_greenBBBFBBB(da, this, ro, bo_end_prime_1, bo_begin_prime_1,
				this_state_prime_1);
		// Booking bo = (Booking) result1_green[3];
	...
	public void uploadResults_v0(GradeFormular gF) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_uploadRes_v0] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[gF] = " + gF + ".");
		}
		EX_STATE this_state_prime_1 = (EX_STATE) result1_black[2];
	...
	public void closeExam_v0() {
		...
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching in node [EX_closeExam_v0] failed." + " Variables: " + "[this] = " + this + ".");
		}
	...
	public void transferResultPassed_v1(SystemTimer system) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_transResPas_v1] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[system] = " + system + ".");
		}
		Record rec = (Record) result1_black[1];
		GradeFormular gradeFormular = (GradeFormular) result1_black[2];
		Entry entry = (Entry) result1_black[3];
		// CoModOffer moduleOffer = (CoModOffer) result1_black[4];
		Enrollment enrollment = (Enrollment) result1_black[5];
		// Semester currSem = (Semester) result1_black[6];
		...
		ExamImpl.pattern_Exam_8_1_EX_transResPas_v1_greenBBBB(rec, enrollment, rec_grade_prime_1,
				enrollment_cp_prime_1);
	...
	public void transferResultFailed_v1(SystemTimer system) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching in node [EX_transResFail_v1] failed." + " Variables: "
					+ "[this] = " + this + ", " + "[system] = " + system + ".");
		}
		Record rec = (Record) result1_black[1];
		GradeFormular gradeFormular = (GradeFormular) result1_black[2];
		...
		ExamImpl.pattern_Exam_9_1_EX_transResFail_v1_greenBBBB(rec, enrollment, rec_grade_prime_1,
				enrollment_enrolled_prime_1);
	...
	public static final Object[] pattern_Exam_0_1_EX_setDate_v0_greenBBB(Date da, Exam _this,
			EX_STATE this_state_prime) {
		_this.setDate(da);
	...
	public static final Object[] pattern_Exam_2_1_EX_bookRoom_v1_blackBBFFBFFF(Exam _this, Room ro,
			SystemTimer system) {
					...
					if (this_state == EX_STATE.EX_PLANNING) {
						...
						if (currSem_current == true) {
							...
							if (currSem_regPeriodStop < system_currentTime) {
								...
								return new Object[] { _this, ro, da, currSem, system, bo_end_prime, bo_begin_prime,
										this_state_prime };
							}
						}
	...
	public static final Object[] pattern_Exam_2_1_EX_bookRoom_v1_greenBBFBBBB(Exam _this, Room ro, Date da,
			long bo_end_prime, long bo_begin_prime, EX_STATE this_state_prime) {
									...
									for (Entry entry : gradeFormular.getRecords()) {
										...
										if (enrollment_studId == entry_studentId) {
											...
											if (entry_grade <= 4) {
												...
												return new Object[] { rec, _this, gradeFormular, entry, moduleOffer,
														enrollment, rec_grade_prime, enrollment_cp_prime };
											}
										}
	...
	public static final Object[] pattern_Exam_3_1_EX_transResPas_v0_redBBBB(Record rec, Exam _this,
	...
	public static final Object[] pattern_Exam_3_1_EX_transResPas_v0_greenBBBB(Record rec, Enrollment enrollment,
			int rec_grade_prime, int enrollment_cp_prime) {
								...
								for (Entry entry : gradeFormular.getRecords()) {
									...
									if (enrollment_studId == entry_studentId) {
										...
										if (entry_grade == 5) {
											...
											return new Object[] { _this, rec, gradeFormular, entry, moduleOffer,
													enrollment, rec_grade_prime, enrollment_enrolled_prime };
										}
									}
	...
	public static final Object[] pattern_Exam_4_1_EX_transResFail_v0_redBBBB(Exam _this, Record rec,
			GradeFormular gradeFormular, Entry entry) {
		rec.setExam(null);
		gradeFormular.getRecords().remove(entry);
	...
	public static final Object[] pattern_Exam_4_1_EX_transResFail_v0_greenBBBB(Record rec, Enrollment enrollment,
			int rec_grade_prime, boolean enrollment_enrolled_prime) {
		rec.setGrade(Integer.valueOf(rec_grade_prime));
	...
	public static final Object[] pattern_Exam_5_1_EX_bookRoom_v0_greenBBBFBBB(Date da, Exam _this, Room ro,
			long bo_end_prime, long bo_begin_prime, EX_STATE this_state_prime) {
		Booking bo = CmsNewFactory.eINSTANCE.createBooking();
		_this.setState(this_state_prime);
		da.setLocation(bo);
	...
	public static final Object[] pattern_Exam_6_1_EX_uploadRes_v0_greenBBB(Exam _this, GradeFormular gF,
			EX_STATE this_state_prime) {
												...
												for (Entry entry : gradeFormular.getRecords()) {
													...
													if (enrollment_studId == entry_studentId) {
														...
														if (entry_grade <= 4) {
															...
															rec_grade_prime = entry_grade;
															return new Object[] { _this, rec, gradeFormular, entry,
																	moduleOffer, enrollment, currSem, system,
																	rec_grade_prime, enrollment_cp_prime };
														}
													}
	...
	public static final Object[] pattern_Exam_8_1_EX_transResPas_v1_redBBBB(Exam _this, Record rec,
			GradeFormular gradeFormular, Entry entry) {
		rec.setExam(null);
		gradeFormular.getRecords().remove(entry);
		return new Object[] { _this, rec, gradeFormular, entry };
	...
	public static final Object[] pattern_Exam_8_1_EX_transResPas_v1_greenBBBB(Record rec, Enrollment enrollment,
			int rec_grade_prime, int enrollment_cp_prime) {
		rec.setGrade(Integer.valueOf(rec_grade_prime));
		enrollment.setCp(Integer.valueOf(enrollment_cp_prime));
		return new Object[] { rec, enrollment, rec_grade_prime, enrollment_cp_prime };
											...
											for (Entry entry : gradeFormular.getRecords()) {
												...
												if (enrollment_studId == entry_studentId) {
													...
													if (entry_grade == 5) {
														...
														enrollment_enrolled_prime = failed ? false
																: enrollment_enrolled;
														return new Object[] { _this, rec, gradeFormular, entry,
																moduleOffer, enrollment, currSem, system,
																rec_grade_prime, enrollment_enrolled_prime };
													}
												}
	...
	public static final Object[] pattern_Exam_9_1_EX_transResFail_v1_redBBBB(Exam _this, Record rec,
			GradeFormular gradeFormular, Entry entry) {
		rec.setExam(null);
		gradeFormular.getRecords().remove(entry);
		return new Object[] { _this, rec, gradeFormular, entry };
	...
	public static final Object[] pattern_Exam_9_1_EX_transResFail_v1_greenBBBB(Record rec, Enrollment enrollment,
			int rec_grade_prime, boolean enrollment_enrolled_prime) {
		rec.setGrade(Integer.valueOf(rec_grade_prime));
		enrollment.setEnrolled(Boolean.valueOf(enrollment_enrolled_prime));
		return new Object[] { rec, enrollment, rec_grade_prime, enrollment_enrolled_prime };
