 ...
 * <ul>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.SystemTimerImpl#getCurrentTime
...
public class SystemTimerImpl extends EObjectImpl implements SystemTimer {
	/**
	 * The default value of the '{@link #getCurrentTime() <em>Current Time</em>}'
	...
	/**
	 * The cached value of the '{@link #getCurrentTime() <em>Current Time</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getCurrentTime()
	 * @generated
	...
	public void setCurrentTime(long newCurrentTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.SYSTEM_TIMER__CURRENT_TIME,
