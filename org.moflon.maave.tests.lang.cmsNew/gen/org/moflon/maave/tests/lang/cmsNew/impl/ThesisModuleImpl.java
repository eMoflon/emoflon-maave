 ...
 * <ul>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisModuleImpl#getActThesModOffer
 * <em>Act Thes Mod Offer</em>}</li>
 * <li>{@link org.moflon.maave.tests.lang.cmsNew.impl.ThesisModuleImpl#getId
 * <em>Id</em>}</li>
 * </ul>
 * </p>
 *
...
public class ThesisModuleImpl extends EObjectImpl implements ThesisModule {
	/**
	 * The cached value of the '{@link #getActThesModOffer() <em>Act Thes Mod
	 * Offer</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	public NotificationChain basicSetActThesModOffer(ThesisModuleOffer newActThesModOffer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CmsNewPackage.THESIS_MODULE__ACT_THES_MOD_OFFER, oldActThesModOffer, newActThesModOffer);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setActThesModOffer(ThesisModuleOffer newActThesModOffer) {
		if (newActThesModOffer != actThesModOffer) {
			...
			if (actThesModOffer != null)
				msgs = ((InternalEObject) actThesModOffer).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.THESIS_MODULE__ACT_THES_MOD_OFFER, null, msgs);
			if (newActThesModOffer != null)
				msgs = ((InternalEObject) newActThesModOffer).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - CmsNewPackage.THESIS_MODULE__ACT_THES_MOD_OFFER, null, msgs);
			msgs = basicSetActThesModOffer(newActThesModOffer, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsNewPackage.THESIS_MODULE__ACT_THES_MOD_OFFER,
					newActThesModOffer, newActThesModOffer));
	}
