...
public class PatternBodyDataFrame extends InterpretedDataFrame {
	private final PatternBody specification;

	public PatternBodyDataFrame(PatternBody specification, int size) {
		super(size);
