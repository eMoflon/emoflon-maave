 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.vwxyz.impl.VImpl#getW <em>W</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.vwxyz.impl.VImpl#getX <em>X</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VImpl extends EObjectImpl implements V {
	...
	protected EClass eStaticClass() {
		return VwxyzPackage.Literals.V;
	}
	...
	public EList<W> getW() {
		if (w == null) {
			w = new EObjectContainmentEList<W>(W.class, this, VwxyzPackage.V__W);
		}
		return w;
	}
	...
	public void setX(int newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VwxyzPackage.V__X, oldX, x));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case VwxyzPackage.V__W:
			getW().clear();
			getW().addAll((Collection<? extends W>) newValue);
			return;
		case VwxyzPackage.V__X:
