 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.RoomImpl#getReservations <em>Reservations</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.RoomImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomImpl extends EObjectImpl implements Room {
	...
	protected EClass eStaticClass() {
		return CmsPackage.Literals.ROOM;
	}
	...
	public EList<Booking> getReservations() {
		if (reservations == null) {
			reservations = new EObjectContainmentWithInverseEList<Booking>(Booking.class, this,
					CmsPackage.ROOM__RESERVATIONS, CmsPackage.BOOKING__ROOM);
		}
		return reservations;
	}
	...
	public void setCapacity(int newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsPackage.ROOM__CAPACITY, oldCapacity, capacity));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CmsPackage.ROOM__RESERVATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CmsPackage.ROOM__CAPACITY:
			return getCapacity();
		}
