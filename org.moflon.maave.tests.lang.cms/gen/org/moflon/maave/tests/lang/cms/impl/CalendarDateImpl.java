 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.CalendarDateImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.CalendarDateImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.CalendarDateImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CalendarDateImpl extends EObjectImpl implements CalendarDate {
	/**
	...
	protected EClass eStaticClass() {
		return CmsPackage.Literals.CALENDAR_DATE;
	}
		...
		if (location != null && location.eIsProxy()) {
			...
			if (location != oldLocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CmsPackage.CALENDAR_DATE__LOCATION,
	...
	public void setLocation(Booking newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsPackage.CALENDAR_DATE__LOCATION, oldLocation,
					location));
	}
	...
	public void setBegin(long newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsPackage.CALENDAR_DATE__BEGIN, oldBegin, begin));
	}
	...
	public void setDuration(long newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsPackage.CALENDAR_DATE__DURATION, oldDuration,
					duration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CmsPackage.CALENDAR_DATE__LOCATION:
			if (resolve)
				return getLocation();
			return basicGetLocation();
		case CmsPackage.CALENDAR_DATE__BEGIN:
			return getBegin();
		case CmsPackage.CALENDAR_DATE__DURATION:
			return getDuration();
		}
