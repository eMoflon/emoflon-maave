 ...
 * <ul>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.EntryImpl#getStudentId <em>Student Id</em>}</li>
 *   <li>{@link org.moflon.maave.tests.lang.cms.impl.EntryImpl#getGrade <em>Grade</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntryImpl extends EObjectImpl implements Entry {
	...
	protected EClass eStaticClass() {
		return CmsPackage.Literals.ENTRY;
	}
	...
	public void setStudentId(int newStudentId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsPackage.ENTRY__STUDENT_ID, oldStudentId,
					studentId));
	}
	...
	public void setGrade(int newGrade) {
		...
		grade = newGrade;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsPackage.ENTRY__GRADE, oldGrade, grade));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CmsPackage.ENTRY__STUDENT_ID:
			return getStudentId();
		case CmsPackage.ENTRY__GRADE:
			return getGrade();
		}
