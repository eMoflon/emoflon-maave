...
public class Adornment {
	...
	public static final Adornment BOUND_BOUND = new Adornment(new boolean[] { BOUND, BOUND });
	public static final Adornment FREE_BOUND = new Adornment(new boolean[] { FREE, BOUND });
	public static final Adornment BOUND_FREE = new Adornment(new boolean[] { BOUND, FREE });
	public static final Adornment FREE_FREE = new Adornment(new boolean[] { FREE, FREE });
	...
	public int hashCode() {
		...
		byte[] bytes = new byte[size + Integer.SIZE];
		int index = 0;
		for (int i = 0; i < bits.length; i++) {
