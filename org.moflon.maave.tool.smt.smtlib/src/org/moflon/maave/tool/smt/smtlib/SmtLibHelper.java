...
public class SmtLibHelper {
	...
	private static final URI BUILDIN_SMT_LIB_URI = URI
			.createPlatformPluginURI("/" + BUILDIN_SMT_LIB_PROJECT + "/lib/SMTLib.xmi", true);
	private SMTLib lib;
	...
	private Resource loadSMTLibResource(URI uri, boolean createOnDemand) {
		...
		rset.getURIConverter().getURIMap().put(URI.createPlatformPluginURI("/" + BUILDIN_SMT_LIB_PROJECT + "/", true),
				URI.createPlatformResourceURI("/" + BUILDIN_SMT_LIB_PROJECT + "/", true));
		Resource res = null;
