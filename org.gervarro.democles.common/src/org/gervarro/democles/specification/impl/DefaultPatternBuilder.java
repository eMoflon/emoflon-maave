...
public class DefaultPatternBuilder<P extends Pattern, PB> extends PatternBuilder<P, PB> {
	...
	public final P build(org.gervarro.democles.specification.Pattern pattern) {
		Map<org.gervarro.democles.specification.Variable, Variable> variableMap = new HashMap<org.gervarro.democles.specification.Variable, Variable>();
		List<? extends org.gervarro.democles.specification.Variable> symbolicParameters = pattern
	...
	public final Collection<P> build(Iterable<org.gervarro.democles.specification.Pattern> patterns) {
		Map<org.gervarro.democles.specification.Pattern, P> patternMap = new HashMap<org.gervarro.democles.specification.Pattern, P>();
	...
	private PB buildPatternBody(org.gervarro.democles.specification.PatternBody body,
		...
		Map<org.gervarro.democles.specification.ConstraintVariable, ConstraintVariable> slotMap = new HashMap<org.gervarro.democles.specification.ConstraintVariable, ConstraintVariable>(
				symbolicParameterMap);
