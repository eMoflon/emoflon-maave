...
public class RBACTest {
	...
	public void test1() {
		...
		// SymbolicGraph
		// graphG=ModelHelper.getRule(cls,"testpattern2Inconsistent").getLeft().getCodom();
		// graphG.setName("G");
		//
		//
		// SymbolicGraphMorphism
		// emptyMorL_G=SymbolicGraphMorphismsFactory.eINSTANCE.createSymbolicGraphMorphism();
		// emptyMorL_G.setDom(graphL);
		// emptyMorL_G.setCodom(graphG);
		//
		// MorphismFinderFactory
		// morFinderFac=MatchingFactory.eINSTANCE.createMorphismFinderFactory();
		// IMorphismFinder morFinderForL=morFinderFac.createMorphismFinder(graphL,
		// gts.getMatchMorphismClass());
		// MorphismsSet morSetL_G=morFinderForL.getAllMorphisms(emptyMorL_G);
		//
		// DirectDerivationBuilder
		// derBuilder=GraphtransformationFactory.eINSTANCE.createProjectiveDirectDerivationBuilder();
		// DirectDerivationSet derSet=derBuilder.deriveAllDirectDerivations(rule,
		// morSetL_G, gts, true);
		//
