...
//      Assert.assertTrue(R.getFormula().getQuantifier().getLabelNodes().stream().anyMatch(x->x.getLabel().equals("temp")));
   ...
   public  void test7(){
      ...
      Assert.assertTrue("FailedAssert: 10c",L.getFormula().getQuantifier().getLabelNodes().get(0).getLabel().equals("c_x_prime"));
      ...
      Assert.assertTrue("FailedAssert: 22c",K.getFormula().getQuantifier().getLabelNodes().get(0).getLabel().equals("c_x_prime"));
