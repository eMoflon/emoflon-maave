...
public class TestForStoryPatternToSymbGraTraRules_NAC {
	...
	public void test3() {
		...
		MoflonEOperation operation = (MoflonEOperation) cls.getEOperations().stream()
				.filter(x -> x.getName().equals("nacTestPattern3")).findFirst().get();
		...
		Assert.assertTrue("FailedAssert: 8", L.getLabelNodes().stream()
		...
		Assert.assertTrue("FailedAssert: 11",
		...
		Assert.assertTrue("FailedAssert: 12B", L.getFormula().getConstants().stream()
		...
		Assert.assertTrue("FailedAssert: 17", K.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 18", K.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c") && x.getType().getName().equals("C")));

		Assert.assertTrue("FailedAssert: 19", K.getGraphEdges().size() == 1);
		Assert.assertTrue("FailedAssert: 20",
		...
		Assert.assertTrue("FailedAssert: 22", K.getLabelNodes().stream()
				.anyMatch(x -> x.getLabel().equals("a_x") && x.getType().getName().equals("EInt")));
		Assert.assertTrue("FailedAssert: 23", K.getLabelNodes().stream()
				.anyMatch(x -> x.getLabel().equals("a_x_prime") && x.getType().getName().equals("EInt")));
		...
		Assert.assertTrue("FailedAssert: 26B", K.getFormula().getConstants().stream()
				.anyMatch(x -> x.getInterpretation().equals("1") && x.getType().getName().equals("EInt")));
		...
		Assert.assertTrue("FailedAssert: 31", R.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 32", R.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c") && x.getType().getName().equals("C")));

		Assert.assertTrue("FailedAssert: 33", R.getGraphEdges().size() == 1);
		Assert.assertTrue("FailedAssert: 34",
		...
		Assert.assertTrue("FailedAssert: 36", R.getLabelNodes().stream()
				.anyMatch(x -> x.getLabel().equals("a_x") && x.getType().getName().equals("EInt")));
		Assert.assertTrue("FailedAssert: 37", R.getLabelNodes().stream()
				.anyMatch(x -> x.getLabel().equals("a_x_prime") && x.getType().getName().equals("EInt")));

		Assert.assertTrue("FailedAssert: 39", R.getLabelEdges().size() == 2);
		Assert.assertTrue("FailedAssert: 40",
		...
		Assert.assertTrue("FailedAssert: 41B", R.getFormula().getConstants().stream()
				.anyMatch(x -> x.getInterpretation().equals("1") && x.getType().getName().equals("EInt")));
		...
		Assert.assertTrue("FailedAssert: 48", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 49", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c") && x.getType().getName().equals("C")));

		Assert.assertTrue("FailedAssert: 50", X.getGraphEdges().size() == 1);
		Assert.assertTrue("FailedAssert: 51",
				X.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("a")
						&& x.getTarget().getDebugId().equals("c") && x.getType().getName().equals("c")));

		Assert.assertTrue("FailedAssert: 52", X.getLabelNodes().size() == 3);
		Assert.assertTrue("FailedAssert: 53", X.getLabelNodes().stream()
				.anyMatch(x -> x.getLabel().equals("a_x") && x.getType().getName().equals("EInt")));
		Assert.assertTrue("FailedAssert: 54", X.getLabelNodes().stream()
				.anyMatch(x -> x.getLabel().equals("a_x_prime") && x.getType().getName().equals("EInt")));
		Assert.assertTrue("FailedAssert: 55", X.getLabelNodes().stream()
		...
		Assert.assertTrue("FailedAssert: 58",
				X.getLabelEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("a")
						&& x.getTarget().getLabel().equals("a_x") && x.getType().getName().equals("x")));
		Assert.assertTrue("FailedAssert: 59",
				X.getLabelEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("c")
		...
		Assert.assertTrue("FailedAssert: 60B", X.getFormula().getConstants().stream()
				.anyMatch(x -> x.getInterpretation().equals("1") && x.getType().getName().equals("EInt")));
		...
		Assert.assertTrue("FailedAssert: 62",
				X.getFormula().getOf().get(0).getOf().stream().anyMatch(x -> x.getSymbol().equals("#T")));
		Assert.assertTrue("FailedAssert: 63",
				X.getFormula().getOf().get(0).getOf().stream()
						.anyMatch(x -> x.getSymbol().equals("+") && x.getParameters().size() == 3
								&& ((LabelNode) x.getParameters().get(0)).getLabel().equals("a_x_prime")
								&& ((LabelNode) x.getParameters().get(1)).getLabel().equals("a_x")
								&& ((Constant) x.getParameters().get(2)).getInterpretation().equals("1")));
		Assert.assertTrue("FailedAssert: 64",
				X.getFormula().getOf().get(0).getOf().stream()
	...
	public void test2() {
		...
		EClass cls = (EClass) pack.getEClassifier("NacPatternGenerator");
		MoflonEOperation operation = (MoflonEOperation) cls.getEOperations().stream()
				.filter(x -> x.getName().equals("nacTestPattern2")).findFirst().get();
		StoryNode stn = (StoryNode) operation.getActivity().getOwnedActivityNode().stream()
				.filter(x -> x instanceof StoryNode).collect(Collectors.toList()).get(0);
		...
		Assert.assertTrue("FailedAssert: 72", L.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 73", L.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c1") && x.getType().getName().equals("C")));
		...
		Assert.assertTrue("FailedAssert: 78", K.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 79", K.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c1") && x.getType().getName().equals("C")));
		...
		Assert.assertTrue("FailedAssert: 84", R.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 85", R.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c1") && x.getType().getName().equals("C")));
		...
		Assert.assertTrue("FailedAssert: 89", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 90", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c1") && x.getType().getName().equals("C")));
		Assert.assertTrue("FailedAssert: 91", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c2") && x.getType().getName().equals("C")));
		Assert.assertTrue("FailedAssert: 92", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("B") && x.getType().getName().equals("B")));

		Assert.assertTrue("FailedAssert: 93", X.getGraphEdges().size() == 4);

		Assert.assertTrue("FailedAssert: 94",
				X.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("B")
						&& x.getTarget().getDebugId().equals("a") && x.getType().getName().equals("a")));
		Assert.assertTrue("FailedAssert: 95",
				X.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("a")
						&& x.getTarget().getDebugId().equals("B") && x.getType().getName().equals("b")));
		Assert.assertTrue("FailedAssert: 96",
				X.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("c2")
						&& x.getTarget().getDebugId().equals("B") && x.getType().getName().equals("b")));
		Assert.assertTrue("FailedAssert: 97",
				X.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("a")
						&& x.getTarget().getDebugId().equals("c2") && x.getType().getName().equals("c")));
		...
		Assert.assertTrue("FailedAssert: 100", X2.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 101", X2.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("c1") && x.getType().getName().equals("C")));

		Assert.assertTrue("FailedAssert: 102", X2.getGraphEdges().size() == 1);
		Assert.assertTrue("FailedAssert: 103",
				X2.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("a")
						&& x.getTarget().getDebugId().equals("c1") && x.getType().getName().equals("c")));
	...
	public void test1() {
		...
		EClass cls = (EClass) pack.getEClassifier("NacPatternGenerator");
		MoflonEOperation operation = (MoflonEOperation) cls.getEOperations().stream()
				.filter(x -> x.getName().equals("nacTestPattern1")).findFirst().get();
		StoryNode stn = (StoryNode) operation.getActivity().getOwnedActivityNode().stream()
				.filter(x -> x instanceof StoryNode).collect(Collectors.toList()).get(0);
		...
		Assert.assertTrue("FailedAssert: 112", L.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		...
		Assert.assertTrue("FailedAssert: 117", K.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		...
		Assert.assertTrue("FailedAssert: 122", R.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		...
		Assert.assertTrue("FailedAssert: 126", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("a") && x.getType().getName().equals("A")));
		Assert.assertTrue("FailedAssert: 127", X.getGraphNodes().stream()
				.anyMatch(x -> x.getDebugId().equals("b") && x.getType().getName().equals("B")));

		Assert.assertTrue("FailedAssert: 128", X.getGraphEdges().size() == 2);
		Assert.assertTrue("FailedAssert: 129",
				X.getGraphEdges().stream().anyMatch(x -> x.getSource().getDebugId().equals("b")
						&& x.getTarget().getDebugId().equals("a") && x.getType().getName().equals("a")));
