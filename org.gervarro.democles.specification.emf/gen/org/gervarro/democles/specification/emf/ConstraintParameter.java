 ...
 * '<em><b>Constraint Parameter</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.gervarro.democles.specification.emf.ConstraintParameter#getReference
 * <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
...
public class ConstraintParameter extends EObjectImpl {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SpecificationPackage.CONSTRAINT_PARAMETER__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(ConstraintVariable newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecificationPackage.CONSTRAINT_PARAMETER__REFERENCE,
