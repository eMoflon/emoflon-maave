...
public class SpecificationPackage extends EPackageImpl {
	 ...
	 * @generated
	 */
	public static final SpecificationPackage eINSTANCE = org.gervarro.democles.specification.emf.SpecificationPackage
			.init();

	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.Pattern <em>Pattern</em>}'
	...
	/**
	 * The feature id for the '<em><b>Symbolic Parameters</b></em>' containment
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.PatternBody <em>Pattern
	...
	/**
	 * The feature id for the '<em><b>Local Variables</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.Constraint
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.ConstraintVariable
	 * <em>Constraint Variable</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Constraint Variable</em>'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.Variable <em>Variable</em>}'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.Constant <em>Constant</em>}'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.PatternInvocationConstraint
	 * <em>Pattern Invocation Constraint</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Pattern Invocation
	...
	/**
	 * The meta object id for the
	 * '{@link org.gervarro.democles.specification.emf.ConstraintParameter
	 * <em>Constraint Parameter</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Constraint Parameter</em>'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link SpecificationPackage#eINSTANCE} when
	...
	public static SpecificationPackage init() {
		...
		SpecificationPackage theSpecificationPackage = (SpecificationPackage) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof SpecificationPackage ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new SpecificationPackage());
	 ...
	 * '{@link org.gervarro.democles.specification.emf.Pattern#getName
	 ...
	 * '{@link org.gervarro.democles.specification.emf.Pattern#getSymbolicParameters
	 * <em>Symbolic Parameters</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the containment reference list '<em>Symbolic
	 *         Parameters</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list
	 * '{@link org.gervarro.democles.specification.emf.Pattern#getBodies
	 * <em>Bodies</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * '{@link org.gervarro.democles.specification.emf.PatternBody#getHeader
	...
	/**
	 * Returns the meta object for the containment reference list
	 * '{@link org.gervarro.democles.specification.emf.PatternBody#getLocalVariables
	 * <em>Local Variables</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the containment reference list
	 * '{@link org.gervarro.democles.specification.emf.PatternBody#getConstants
	...
	/**
	 * Returns the meta object for the containment reference list
	 * '{@link org.gervarro.democles.specification.emf.PatternBody#getConstraints
	...
	/**
	 * Returns the meta object for the containment reference list
	 * '{@link org.gervarro.democles.specification.emf.Constraint#getParameters
	 ...
	 * Returns the meta object for class
	 * '{@link org.gervarro.democles.specification.emf.ConstraintVariable
	 * <em>Constraint Variable</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the attribute
	 * '{@link org.gervarro.democles.specification.emf.Variable#getName
	 * <em>Name</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Name</em>'.
	...
	/**
	 * Returns the meta object for the attribute
	 * '{@link org.gervarro.democles.specification.emf.Constant#getValue
	 ...
	 * Returns the meta object for class
	 * '{@link org.gervarro.democles.specification.emf.PatternInvocationConstraint
	 * <em>Pattern Invocation Constraint</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 ...
	 * <em>Positive</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Invoked Pattern</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * Returns the meta object for class
	 * '{@link org.gervarro.democles.specification.emf.ConstraintParameter
	 * <em>Constraint Parameter</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns the meta object for the reference
	 * '{@link org.gervarro.democles.specification.emf.ConstraintParameter#getReference
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPattern_Name(), ecorePackage.getEString(), "name", null, 0, 1, Pattern.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPattern_SymbolicParameters(), this.getVariable(), null, "symbolicParameters", null, 0, -1,
				Pattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPattern_Bodies(), this.getPatternBody(), this.getPatternBody_Header(), "bodies", null, 0, -1,
				Pattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(patternBodyEClass, PatternBody.class, "PatternBody", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPatternBody_Header(), this.getPattern(), this.getPattern_Bodies(), "header", null, 1, 1,
				PatternBody.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPatternBody_LocalVariables(), this.getVariable(), null, "localVariables", null, 0, -1,
				PatternBody.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPatternBody_Constants(), this.getConstant(), null, "constants", null, 0, -1,
				PatternBody.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPatternBody_Constraints(), this.getConstraint(), null, "constraints", null, 0, -1,
				PatternBody.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constraintEClass, Constraint.class, "Constraint", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConstraint_Parameters(), this.getConstraintParameter(), null, "parameters", null, 0, -1,
				Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constraintVariableEClass, ConstraintVariable.class, "ConstraintVariable", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(variableEClass, Variable.class, "Variable", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVariable_Name(), ecorePackage.getEString(), "name", "", 1, 1, Variable.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constantEClass, Constant.class, "Constant", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getConstant_Value(), ecorePackage.getEJavaObject(), "value", null, 0, 1, Constant.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(patternInvocationConstraintEClass, PatternInvocationConstraint.class, "PatternInvocationConstraint",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPatternInvocationConstraint_Positive(), ecorePackage.getEBoolean(), "positive", null, 1, 1,
				PatternInvocationConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPatternInvocationConstraint_InvokedPattern(), this.getPattern(), null, "invokedPattern", null,
				1, 1, PatternInvocationConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(constraintParameterEClass, ConstraintParameter.class, "ConstraintParameter", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConstraintParameter_Reference(), this.getConstraintVariable(), null, "reference", null, 1, 1,
				ConstraintParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	public interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Symbolic Parameters</b></em>'
		...
		/**
		 * The meta object literal for the '<em><b>Bodies</b></em>' containment
		...
		/**
		 * The meta object literal for the '<em><b>Header</b></em>' container reference
		...
		/**
		 * The meta object literal for the '<em><b>Local Variables</b></em>' containment
		 * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Constants</b></em>' containment
		 * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		 ...
		 * @generated
		 */
		public static final EAttribute PATTERN_INVOCATION_CONSTRAINT__POSITIVE = eINSTANCE
				.getPatternInvocationConstraint_Positive();

		/**
		 * The meta object literal for the '<em><b>Invoked Pattern</b></em>' reference
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		public static final EReference PATTERN_INVOCATION_CONSTRAINT__INVOKED_PATTERN = eINSTANCE
				.getPatternInvocationConstraint_InvokedPattern();
