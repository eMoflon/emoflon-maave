...
public class SpecificationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SpecificationPackage.CONSTRAINT: {
		...
		case SpecificationPackage.CONSTRAINT_VARIABLE: {
			ConstraintVariable constraintVariable = (ConstraintVariable) theEObject;
			T result = caseConstraintVariable(constraintVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecificationPackage.VARIABLE: {
			Variable variable = (Variable) theEObject;
			T result = caseVariable(variable);
			if (result == null)
				result = caseConstraintVariable(variable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecificationPackage.CONSTANT: {
			...
			if (result == null)
				result = caseConstraintVariable(constant);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SpecificationPackage.PATTERN_INVOCATION_CONSTRAINT: {
			PatternInvocationConstraint patternInvocationConstraint = (PatternInvocationConstraint) theEObject;
			T result = casePatternInvocationConstraint(patternInvocationConstraint);
			if (result == null)
				result = caseConstraint(patternInvocationConstraint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * Body</em>'. <!-- begin-user-doc --> This implementation returns null;
	 * returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Constraint Variable</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pattern
	 * Invocation Constraint</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pattern
	 *         Invocation Constraint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePatternInvocationConstraint(PatternInvocationConstraint object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of
	 * '<em>Constraint Parameter</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
