...
public class RelationalConstraintAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected RelationalConstraintSwitch<Adapter> modelSwitch = new RelationalConstraintSwitch<Adapter>() {
		@Override
	 ...
	 * <em>Relational Constraint</em>}'. <!-- begin-user-doc --> This default
	 ...
	 * <em>Equal</em>}'. <!-- begin-user-doc --> This default implementation returns
	 ...
	 * <em>Unequal</em>}'. <!-- begin-user-doc --> This default implementation
	 ...
	 * <em>Smaller</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	 ...
	 * <em>Smaller Or Equal</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 ...
	 * <em>Larger</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	 ...
	 * <em>Larger Or Equal</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
