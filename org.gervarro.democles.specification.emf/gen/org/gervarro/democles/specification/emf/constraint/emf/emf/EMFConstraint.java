 ...
 * <ul>
 * <li>{@link org.gervarro.democles.specification.emf.constraint.emf.emf.EMFConstraint#getEModelElement
...
public abstract class EMFConstraint<E extends ETypedElement> extends Constraint implements EObject {
	/**
	 * The cached value of the '{@link #getEModelElement() <em>EModel Element</em>}'
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>EModel Element</em>' reference isn't clear, there
			...
			if (eModelElement != oldEModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EMFTypePackage.EMF_CONSTRAINT__EMODEL_ELEMENT, oldEModelElement, eModelElement));
			}
		}
	...
	public void setEModelElement(E newEModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFTypePackage.EMF_CONSTRAINT__EMODEL_ELEMENT,
