 ...
 * Body</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.gervarro.democles.specification.emf.PatternBody#getHeader
 * <em>Header</em>}</li>
 * <li>{@link org.gervarro.democles.specification.emf.PatternBody#getLocalVariables
 * <em>Local Variables</em>}</li>
 * <li>{@link org.gervarro.democles.specification.emf.PatternBody#getConstants
 * <em>Constants</em>}</li>
 * <li>{@link org.gervarro.democles.specification.emf.PatternBody#getConstraints
...
public class PatternBody extends EObjectImpl {
	/**
	 * The cached value of the '{@link #getLocalVariables() <em>Local
	...
	/**
	 * Returns the value of the '<em><b>Header</b></em>' container reference. It is
	 * bidirectional and its opposite is
	 * '{@link org.gervarro.democles.specification.emf.Pattern#getBodies
	 * <em>Bodies</em>}'. <!-- begin-user-doc -->
	 * <p>
	...
	public Pattern getHeader() {
		if (eContainerFeatureID() != SpecificationPackage.PATTERN_BODY__HEADER)
			return null;
	 ...
	 * <em>Header</em>}' container reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Header</em>' container reference.
	 * @see #getHeader()
	 * @generated
	 */
	public void setHeader(Pattern newHeader) {
		if (newHeader != eInternalContainer()
				|| (eContainerFeatureID() != SpecificationPackage.PATTERN_BODY__HEADER && newHeader != null)) {
			...
			if (newHeader != null)
				msgs = ((InternalEObject) newHeader).eInverseAdd(this, SpecificationPackage.PATTERN__BODIES,
						Pattern.class, msgs);
			msgs = basicSetHeader(newHeader, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecificationPackage.PATTERN_BODY__HEADER, newHeader,
					newHeader));
	}
	 ...
	 * {@link org.gervarro.democles.specification.emf.Variable}. <!-- begin-user-doc
	 * -->
	 * <p>
	...
	public EList<Variable> getLocalVariables() {
		if (localVariables == null) {
			localVariables = new EObjectContainmentEList<Variable>(Variable.class, this,
					SpecificationPackage.PATTERN_BODY__LOCAL_VARIABLES);
		}
	 ...
	 * {@link org.gervarro.democles.specification.emf.Constant}. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Constants</em>' containment reference list isn't
	...
	public EList<Constant> getConstants() {
		if (constants == null) {
			constants = new EObjectContainmentEList<Constant>(Constant.class, this,
					SpecificationPackage.PATTERN_BODY__CONSTANTS);
		}
		return constants;
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<Constraint>(Constraint.class, this,
					SpecificationPackage.PATTERN_BODY__CONSTRAINTS);
		}
		return constraints;
	}
