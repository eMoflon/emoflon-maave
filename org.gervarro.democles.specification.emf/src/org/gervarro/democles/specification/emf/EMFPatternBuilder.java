...
public class EMFPatternBuilder<P extends org.gervarro.democles.specification.impl.Pattern, PB>
	...
	public final P build(Pattern pattern) {
		Map<Variable, org.gervarro.democles.specification.impl.Variable> variableMap = new HashMap<Variable, org.gervarro.democles.specification.impl.Variable>();
	...
	public final Collection<P> build(Iterable<Pattern> patterns) {
		...
		for (P newPattern : patternMap.values()) {
			patternRegistry.put(
					PatternMatcherPlugin.getIdentifier(newPattern.getName(), newPattern.getSymbolicParameters().size()),
					newPattern);
		}
	...
	private PB buildPatternBody(PatternBody body,
		...
		Map<ConstraintVariable, org.gervarro.democles.specification.impl.ConstraintVariable> slotMap = new HashMap<ConstraintVariable, org.gervarro.democles.specification.impl.ConstraintVariable>(
				symbolicParameterMap);
		List<? extends Variable> localVariables = body.getLocalVariables();
		org.gervarro.democles.specification.impl.Variable[] newLocalVariables = new org.gervarro.democles.specification.impl.Variable[localVariables
				.size()];
		...
		org.gervarro.democles.specification.impl.Constant[] newConstants = new org.gervarro.democles.specification.impl.Constant[constants
				.size()];
		...
		org.gervarro.democles.specification.impl.Constraint[] newConstraints = new org.gervarro.democles.specification.impl.Constraint[constraints
				.size()];
	...
	private final org.gervarro.democles.specification.impl.Constraint buildConstraint(Constraint constraint,
		...
		org.gervarro.democles.specification.impl.ConstraintVariable[] newParameters = new org.gervarro.democles.specification.impl.ConstraintVariable[parameters
				.size()];
