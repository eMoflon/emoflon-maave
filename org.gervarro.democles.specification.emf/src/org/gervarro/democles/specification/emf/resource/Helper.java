...
public class Helper extends XMIHelperImpl {
	private Map<String, TypeModule> sessions = new HashMap<String, TypeModule>();
	...
	public String convertToString(EFactory eFactory, EDataType eDataType, Object value) {
		...
		// SpecificationPackage.Literals.CONSTRAINT_TYPE.isInstance(value)) {
		...
		// // throw new RuntimeException("Handler for ConstraintType " +
		// value.getClass() + " cannot be found.");
		// } else if (SpecificationPackage.Literals.VARIABLE_TYPE == eDataType &&
		// SpecificationPackage.Literals.VARIABLE_TYPE.isInstance(value)) {
		...
		// // throw new RuntimeException("Handler for VariableType " + value.getClass()
		// + " cannot be found.");
		// }
	...
	protected Object createFromString(EFactory eFactory, EDataType eDataType, String value) {
		...
		// for (TypeModuleProxy module :
		// getResource().getPlugin().getTypeModuleProxies()) {
		...
		// }
		// }
		// throw new RuntimeException("Handler for ConstraintType " + value + " cannot
		// be found.");
		// }
		...
		// }
		// }
		// throw new RuntimeException("Handler for VariableType " + value + " cannot be
		// found.");
		// }
		// throw new RuntimeException("Invalid identifier: " + value);
		// }
	...
	// value, int position) {
	// if (SpecificationPackage.eINSTANCE.getConstraint().isInstance(object) &&
	// SpecificationPackage.eINSTANCE.getConstraint_Type() == feature) {
	// value = getResource().resolve((ConstraintType) value);
	// if (value instanceof InternalEObject && ((InternalEObject) value).eIsProxy())
	// {
	// throw new RuntimeException("Constraint type " + ((InternalEObject)
	// value).eProxyURI().toString() + " cannot be resolved.");
	// }
	// }
	// if (SpecificationPackage.eINSTANCE.getVariable().isInstance(object) &&
	// SpecificationPackage.eINSTANCE.getVariable_Type() == feature) {
	// value = getResource().resolve((VariableType) value);
	// if (value instanceof InternalEObject && ((InternalEObject) value).eIsProxy())
	// {
	// throw new RuntimeException("Variable type " + ((InternalEObject)
	// value).eProxyURI().toString() + " cannot be resolved.");
	// }
	// }
